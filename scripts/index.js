...
const popupEditProfile = document.querySelector('.popup__container_popup_edit_profile');
const popupAddCard = document.querySelector('.popup__container_popup_add_card');
